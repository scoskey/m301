...
\begin{example}
  Continuing the example from above, the first step of elimination will be $R_2-2R_1\to R_2$. We can carry this out by multiplying both sides (on the left) by the ``elimination matrix''
...
[Complete the above example, keeping track of the elimination matrices.]
...
\begin{activity}
  \item Write down the $4\times4$ matrices corresponding to the row operations:
    ...
    \end{enumerate}
  \item For each system of equations, write the corresponding matrix version of the system and use elimination to solve it.  In each step, keep note of the elimination matrices you used.
    \begin{enumerate}
